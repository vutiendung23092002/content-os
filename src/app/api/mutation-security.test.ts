...
const authorizationGuard =
  /assertRequestPageAccess|assertRequestPostAccess|authorizeRequestPostAccess|assertInternalAccess|assertInternalAdminAccess|requireApprovedViewer|requireAdmin|requireSuperAdmin|assertFacebookCronAccess|assertAssetCleanupAccess|createSupabaseServerClient/;
