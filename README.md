...
- Điền cấu hình production/staging: [Hướng dẫn environment](docs/18-ENVIRONMENT-CONFIGURATION.md)
...
| [18-ENVIRONMENT-CONFIGURATION.md](docs/18-ENVIRONMENT-CONFIGURATION.md) | Cấu hình environment production/staging |
